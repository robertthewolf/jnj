...
export default class JewelleryPage extends React.Component {
...
export const jewelleryPageQuery = graphql`
  query jewelleryQuery {
    allMarkdownRemark(filter: {frontmatter: {category: { eq: "jewellery" } }}) {
      edges {
        node {
          id
          frontmatter {
